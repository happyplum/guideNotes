import{_ as e,c as a,o as t,a2 as s}from"./chunks/framework.DF6XNHDf.js";const m=JSON.parse('{"title":"packages 笔记","description":"","frontmatter":{"sidebar":"auto"},"headers":[],"relativePath":"notes/packages/index.md","filePath":"notes/packages/index.md"}'),r={name:"notes/packages/index.md"},n=s(`<h1 id="packages-笔记" tabindex="-1">packages 笔记 <a class="header-anchor" href="#packages-笔记" aria-label="Permalink to &quot;packages 笔记&quot;">​</a></h1><h2 id="关于版本号" tabindex="-1">关于版本号 <a class="header-anchor" href="#关于版本号" aria-label="Permalink to &quot;关于版本号&quot;">​</a></h2><p>&quot;element-ui&quot;: &quot;^2.15.1&quot;, 版本号： 2.15.1 对应 x.y.z z ：表示一些小的bugfix, 更改z的号；(修复补丁-z)（~符号) y ：表示一些大的版本更改，比如一些API的变化；(次要更新-y)(^符号) x ：表示一些设计的变动及模块的重构之类的，会升级x版本号；(重大更新-x)</p><h2 id="packages符号记录" tabindex="-1">packages符号记录 <a class="header-anchor" href="#packages符号记录" aria-label="Permalink to &quot;packages符号记录&quot;">​</a></h2><p>~ 2.15.1 =&gt; 2.15.x 2.15.x =&gt; 2.15.x 2.15.0 =&gt; 2.15.x ^ 2.15.1 =&gt; 2.x.x 2.15.x =&gt; 2.x.x 2.15.0 =&gt; 2.x.x latest 最新版本 2.15.1 直接精确版本</p><h2 id="关于npm-check-update的tags" tabindex="-1">关于npm-check-update的tags <a class="header-anchor" href="#关于npm-check-update的tags" aria-label="Permalink to &quot;关于npm-check-update的tags&quot;">​</a></h2><pre><code>┌──────────┬──────────────────────────────────────────────────────────────────────────────────────────────┐
...
└──────────┴──────────────────────────────────────────────────────────────────────────────────────────────┘
</code></pre>`,7),o=[n];function i(h,c,p,d,g,l){return t(),a("div",null,o)}const x=e(r,[["render",i]]);export{m as __pageData,x as default};
