import{_ as i,c as a,o as n,ae as l}from"./chunks/framework.DtxlzkAV.js";const g=JSON.parse('{"title":".gitlab-ci.yml","description":"","frontmatter":{},"headers":[],"relativePath":"deno/gitlabrunner/index.md","filePath":"deno/gitlabrunner/index.md"}'),p={name:"deno/gitlabrunner/index.md"};function h(t,s,k,e,E,r){return n(),a("div",null,[...s[0]||(s[0]=[l(`<h1 id="gitlab-ci-yml" tabindex="-1">.gitlab-ci.yml <a class="header-anchor" href="#gitlab-ci-yml" aria-label="Permalink to &quot;.gitlab-ci.yml&quot;">​</a></h1><div class="language-yml vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">yml</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">stages</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">:</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">    - </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">build-job</span></span></code></pre></div>`,2)])])}const c=i(p,[["render",h]]);export{g as __pageData,c as default};
